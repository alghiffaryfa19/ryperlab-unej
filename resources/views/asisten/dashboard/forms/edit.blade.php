    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <form action="{{ route('formbuilders::form.asisten.update', [$kelas->id,$form]) }}" method="POST" id="createFormForm" data-form-method="PUT">
                    @csrf 
                    @method('PUT')
                    ...
                    <div class="flex flex-col mb-4">
                        ...
                        <div class="relative">
                            ...
                            <input type="hidden" name="kelas_id" id="kelas" value="{{$kelas->id}}">
