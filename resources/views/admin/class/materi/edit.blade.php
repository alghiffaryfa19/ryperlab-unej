...
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
    <div class="container mx-auto px-6 py-8">
        <h3 class="text-gray-700 text-3xl font-medium">Edit Materi {{$materi->title}}</h3>
        ...
        <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
            <form enctype="multipart/form-data" action="{{route('materi.update', [$kelas->id,$materi->id])}}" method="POST">
                @method('PUT')
                @csrf
                <div class="my-5">
