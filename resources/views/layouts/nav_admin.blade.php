                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('class.index')">
                                    {{ __('Kelas') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('project-category.index')">
                                    {{ __('Kategori Project') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('asistant.index')">
                                    {{ __('Asisten') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                        ...
                        <x-nav-link :href="route('participant.index')">
                            {{ __('Participant') }}
                        </x-nav-link>
                        <x-nav-link :href="route('waktu-enroll.index')">
                            {{ __('Waktu Enroll') }}
                        </x-nav-link>
                    </div>
                </div>
